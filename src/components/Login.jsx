...
// As a user, I want to log into the application so that I can manage my business data.
...
// Displays API authentication errors

// Redirects to dashboard on success

// Stores JWT securely (HTTP-only cookie preferred)
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
          <div className="w-80 bg-white p-10 rounded-lg shadow-xl pb-16 ">
            ...
            <div className="mt-20 text-center text-sm font-light"> New here? 
                <Link to="/register" className="underline text-gray-400 hover:text-gray-600"> Create an account </Link>
            </div>
